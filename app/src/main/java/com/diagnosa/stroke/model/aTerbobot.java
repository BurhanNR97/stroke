...
public class aTerbobot extends RecyclerView.Adapter {

    private List<cTerbobot> dataList;

    public aTerbobot(List<cTerbobot> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.tabel_terbobot, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (rowPos == 0) {
            ...
            cTerbobot data = dataList.get(rowPos - 1);
    ...
    public class RowViewHolder extends RecyclerView.ViewHolder {
        ...
        RowViewHolder(View itemView) {
            super(itemView);
            txtKriteria = itemView.findViewById(R.id.tv_terbobotKriteria);
            txtS1 = itemView.findViewById(R.id.tv_terbobotS1);
            txtS2 = itemView.findViewById(R.id.tv_terbobotS2);
            txtS3 = itemView.findViewById(R.id.tv_terbobotS3);
            txtS4= itemView.findViewById(R.id.tv_terbobotS4);
        }
    }
}
