...
public class aAtribut extends RecyclerView.Adapter {

    private List<cAtribut> dataList;

    public aAtribut(List<cAtribut> dataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.tabel_atribut, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (rowPos == 0) {
            ...
            cAtribut data = dataList.get(rowPos - 1);
    ...
    public class RowViewHolder extends RecyclerView.ViewHolder {
        ...
        RowViewHolder(View itemView) {
            super(itemView);
            txtKriteria = itemView.findViewById(R.id.tv_atributkriteria);
            txtS1 = itemView.findViewById(R.id.tv_atributS1);
            txtS2 = itemView.findViewById(R.id.tv_atributS2);
            txtS3 = itemView.findViewById(R.id.tv_atributS3);
            txtS4 = itemView.findViewById(R.id.tv_atributS4);
        }
    }
}
