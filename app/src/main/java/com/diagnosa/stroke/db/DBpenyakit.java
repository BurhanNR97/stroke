...
public class DBpenyakit extends SQLiteOpenHelper {

    public static final String database_name = "stroke_penyakit.db";
    ...
    public DBpenyakit(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query1 = "INSERT INTO " + table_name + "(" + row_kdPenyakit +", "+row_nmPenyakit+")"
                + "VALUES ('S1', 'Stroke Iskemik Emboli'), ('S2', 'Stroke Iskemik Tombotik')," +
                         "('S3', 'Stroke Hemoragik Intraserebral'), ('S4', 'Stroke Hemoragik Subarachnoid')";
        db.execSQL(query);
        db.execSQL(query1);
    }
