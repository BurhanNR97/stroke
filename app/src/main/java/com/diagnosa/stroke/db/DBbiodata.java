...
public class DBbiodata extends SQLiteOpenHelper {

    public static final String database_name = "stroke_bio.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query1 = "INSERT INTO " + table_biodata + "(" + row_NIK + "," + row_nama + ", " + row_tgl + ", " + row_alamat + ", "
                + row_telp + ", " + row_email + ") VALUES(2017020068, 'Sumarni', '25-05-1998', 'Makassar', '0811111111', 'user')";
        db.execSQL(query);
        db.execSQL(query1);
    }
    ...
    public DBbiodata(Context context) {
