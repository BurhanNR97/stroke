...
public class DBdiagnosa extends SQLiteOpenHelper {

    public static final String database_name = "stroke_diagnosa.db";
    ...
    public static final String row_tgl_diagnosa = "tgl_diagnosa";

    private SQLiteDatabase db;

    public DBdiagnosa(Context context) {
